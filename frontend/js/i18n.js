...
(function () {
    ...
    const T = {
        pt: {
            ...
            'hero.headlineBefore': 'Mais que um corte,',
            'hero.headlineAccent': 'uma experiência.',
            'hero.lead': 'Cortes precisos, ambiente premium e marcação online em poucos minutos.',
            'services.eyebrow': 'O que fazemos',
            'services.title': 'Nossos Serviços',
            'services.lead': 'Do clássico ao degradê — escolha o serviço e marque em poucos cliques.',
            'services.viewAll': 'Ver todos',
            'services.book': 'Agendar',
            'booking.eyebrow': 'Agendamento online',
            'booking.title': 'Rápido, fácil e seguro',
            'booking.lead': 'Reserve o seu horário na Sense Barbershop sem chamadas nem espera.',
            'booking.step1': 'Escolha o serviço e o barbeiro',
            'booking.step2': 'Selecione data e hora disponíveis',
            'booking.step3': 'Confirme e receba a marcação na hora',
            'gallery.eyebrow': 'Trabalhos reais',
            'contact.eyebrow': 'Contactos',
            'ctaBand.title': 'Pronto para um novo visual?',
            'ctaBand.lead': 'Marque agora e garanta o seu horário na Sense Barbershop.',
        ...
        en: {
            ...
            'hero.headlineBefore': 'More than a cut,',
            'hero.headlineAccent': 'an experience.',
            'hero.lead': 'Precise cuts, a premium atmosphere and online booking in minutes.',
            'services.eyebrow': 'What we do',
            'services.title': 'Our Services',
            'services.lead': 'From classic to fade — pick a service and book in a few taps.',
            'services.viewAll': 'View all',
            'services.book': 'Book',
            'booking.eyebrow': 'Online booking',
            'booking.title': 'Fast, easy and secure',
            'booking.lead': 'Book your slot at Sense Barbershop with no calls and no waiting.',
            'booking.step1': 'Choose the service and barber',
            'booking.step2': 'Pick an available date and time',
            'booking.step3': 'Confirm and get your booking instantly',
            'gallery.eyebrow': 'Real work',
            'contact.eyebrow': 'Contact',
            'ctaBand.title': 'Ready for a new look?',
            'ctaBand.lead': 'Book now and secure your time at Sense Barbershop.',
        ...
        fr: {
            ...
            'hero.headlineBefore': 'Plus qu\'une coupe,',
            'hero.headlineAccent': 'une expérience.',
            'hero.lead': 'Coupes précises, ambiance premium et réservation en ligne en quelques minutes.',
            'services.eyebrow': 'Ce que nous faisons',
            'services.title': 'Nos Services',
            'services.lead': 'Du classique au dégradé — choisissez un service et réservez en quelques clics.',
            'services.viewAll': 'Tout voir',
            'services.book': 'Réserver',
            'booking.eyebrow': 'Réservation en ligne',
            'booking.title': 'Rapide, simple et sûr',
            'booking.lead': 'Réservez votre créneau chez Sense Barbershop sans appel ni attente.',
            'booking.step1': 'Choisissez le service et le barbier',
            'booking.step2': 'Sélectionnez date et heure disponibles',
            'booking.step3': 'Confirmez et recevez la réservation aussitôt',
            'gallery.eyebrow': 'Travaux réels',
            'contact.eyebrow': 'Contact',
            'ctaBand.title': 'Prêt pour un nouveau look ?',
            'ctaBand.lead': 'Réservez maintenant et gardez votre créneau chez Sense Barbershop.',
        ...
        es: {
            ...
            'hero.headlineBefore': 'Más que un corte,',
            'hero.headlineAccent': 'una experiencia.',
            'hero.lead': 'Cortes precisos, ambiente premium y reserva online en pocos minutos.',
            'services.eyebrow': 'Lo que hacemos',
            'services.title': 'Nuestros Servicios',
            'services.lead': 'De lo clásico al degradado — elige el servicio y reserva en pocos clics.',
            'services.viewAll': 'Ver todos',
            'services.book': 'Reservar',
            'booking.eyebrow': 'Reserva online',
            'booking.title': 'Rápido, fácil y seguro',
            'booking.lead': 'Reserva tu hora en Sense Barbershop sin llamadas ni esperas.',
            'booking.step1': 'Elige el servicio y el barbero',
            'booking.step2': 'Selecciona fecha y hora disponibles',
            'booking.step3': 'Confirma y recibe la reserva al momento',
            'gallery.eyebrow': 'Trabajos reales',
            'contact.eyebrow': 'Contacto',
            'ctaBand.title': '¿Listo para un nuevo look?',
            'ctaBand.lead': 'Reserva ahora y asegura tu hora en Sense Barbershop.',
