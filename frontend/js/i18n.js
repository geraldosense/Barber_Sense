...
(function () {
    ...
    const T = {
        pt: {
            ...
            'services.seeMore': 'Ver mais serviços',
            ...
            'auth.subLogin': 'Entre com o seu email para reservar o seu corte',
            'auth.brandTag': 'A sua conta',
            ...
            'auth.sendRecover': 'Enviar código',
            'auth.enterCodeHint': 'Introduza o código de 6 dígitos e a nova palavra-passe.',
            'auth.tempCode': 'Código temporário',
            ...
            'auth.photoTitle': 'Foto de perfil',
            'auth.photoHint': 'Opcional — toque para escolher uma foto (JPG ou PNG, máx. 8 MB)',
            'auth.photoAdd': 'Adicionar foto',
            'auth.photoChange': 'Alterar foto',
            'auth.photoRemove': 'Remover foto',
        ...
        en: {
            ...
            'auth.subLogin': 'Sign in with your email to book your haircut',
            'auth.brandTag': 'Your account',
            ...
            'auth.sendRecover': 'Send code',
            'auth.enterCodeHint': 'Enter the 6-digit code and your new password.',
            'auth.tempCode': 'Temporary code',
            ...
            'auth.photoTitle': 'Profile photo',
            'auth.photoHint': 'Optional — tap to choose a photo (JPG or PNG, max 8 MB)',
            'auth.photoAdd': 'Add photo',
            'auth.photoChange': 'Change photo',
            'auth.photoRemove': 'Remove photo',
        ...
        fr: {
            ...
            'services.seeMore': 'Voir plus de services',
            'services.seeLess': 'Voir moins',
            ...
            'auth.subLogin': 'Connectez-vous avec votre email pour réserver',
            'auth.brandTag': 'Votre compte',
            ...
            'auth.sendRecover': 'Envoyer le code',
            'auth.enterCodeHint': 'Entrez le code à 6 chiffres et votre nouveau mot de passe.',
            'auth.tempCode': 'Code temporaire',
            ...
            'auth.photoTitle': 'Photo de profil',
            'auth.photoHint': 'Optionnel — appuyez pour choisir une photo (JPG ou PNG, max. 8 Mo)',
            'auth.photoAdd': 'Ajouter une photo',
            'auth.photoChange': 'Changer la photo',
            'auth.photoRemove': 'Supprimer la photo',
        ...
        es: {
            ...
            'services.seeMore': 'Ver más servicios',
            'services.seeLess': 'Ver menos',
            ...
            'auth.subLogin': 'Entra con tu email para reservar tu corte',
            'auth.brandTag': 'Tu cuenta',
            ...
            'auth.sendRecover': 'Enviar código',
            'auth.enterCodeHint': 'Introduce el código de 6 dígitos y la nueva contraseña.',
            'auth.tempCode': 'Código temporal',
            ...
            'auth.photoTitle': 'Foto de perfil',
            'auth.photoHint': 'Opcional — toca para elegir una foto (JPG o PNG, máx. 8 MB)',
            'auth.photoAdd': 'Añadir foto',
            'auth.photoChange': 'Cambiar foto',
            'auth.photoRemove': 'Eliminar foto',
