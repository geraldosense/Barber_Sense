...
(function () {
    ...
    const T = {
        pt: {
            ...
            'auth.photoHint': 'Opcional — JPG ou PNG, máx. 8 MB',
        ...
        en: {
            ...
            'auth.photoHint': 'Optional — JPG or PNG, max 8 MB',
        ...
        fr: {
            ...
            'auth.photoHint': 'Optionnel — JPG ou PNG, max. 8 Mo',
        ...
        es: {
            ...
            'auth.photoTitle': 'Foto de perfil',
            'auth.photoHint': 'Opcional — JPG o PNG, máx. 8 MB',
